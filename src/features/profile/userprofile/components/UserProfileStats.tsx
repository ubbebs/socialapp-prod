  ...
  return (
    <div className="flex gap-5 w-full max-w-[500px]">
      <p className="font-normal text-center text-md">
        Posts: <b>{dataUserPosts ? Object.keys(dataUserPosts).length : 0}</b>
      </p>
      <p className="font-normal text-center text-md">
        <b>{dataUserFollowers ? Object.keys(dataUserFollowers).length : 0}</b>{' '}
        followers
      </p>
      <p className="font-normal text-center text-md">
        <b>{dataUserFollowing ? Object.keys(dataUserFollowing).length : 0}</b>{' '}
        following
      </p>
    </div>
  )
